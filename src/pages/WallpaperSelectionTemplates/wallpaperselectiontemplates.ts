...
@IonicPage({priority: 'low', segment: 'path-to-wallpaperselectiontemplates', defaultHistory: []})
@Component({selector: 'page-wallpaperselectiontemplates', templateUrl: 'wallpaperselectiontemplates.html', changeDetection: ChangeDetectionStrategy.Default})
export class WallpaperSelectionTemplates extends C8oPage  {
	...
	public static nameStatic: string = "WallpaperSelectionTemplates";
	 ...
	 */
	CTS1586164766943(page: C8oPageBase, props, vars, event: any) : Promise<any> {
		return new Promise((resolve, reject) => {
		/*Begin_c8o_function:CTS1586164766943*/
		...
		/*End_c8o_function:CTS1586164766943*/
		});
	}
