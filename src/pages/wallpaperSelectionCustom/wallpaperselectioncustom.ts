...
@IonicPage({priority: 'low', segment: 'path-to-wallpaperselectioncustom', defaultHistory: []})
@Component({selector: 'page-wallpaperselectioncustom', templateUrl: 'wallpaperselectioncustom.html', changeDetection: ChangeDetectionStrategy.Default})
export class wallpaperSelectionCustom extends C8oPage  {
	

	public events : Events;
	public actionBeans: ActionBeans;
	public static nameStatic: string = "wallpaperSelectionCustom";
	 ...
	 */
	CTS1586175070309(page: C8oPageBase, props, vars, event: any) : Promise<any> {
		return new Promise((resolve, reject) => {
		/*Begin_c8o_function:CTS1586175070309*/
		...
		resolve();
		/*End_c8o_function:CTS1586175070309*/
		});
	}
