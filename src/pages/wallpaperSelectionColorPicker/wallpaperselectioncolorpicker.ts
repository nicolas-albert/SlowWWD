...
@IonicPage({priority: 'low', segment: 'path-to-wallpaperselectioncolorpicker', defaultHistory: []})
@Component({selector: 'page-wallpaperselectioncolorpicker', templateUrl: 'wallpaperselectioncolorpicker.html', changeDetection: ChangeDetectionStrategy.Default})
export class wallpaperSelectionColorPicker extends C8oPage  {
	

	public events : Events;
	public actionBeans: ActionBeans;
	public static nameStatic: string = "wallpaperSelectionColorPicker";
