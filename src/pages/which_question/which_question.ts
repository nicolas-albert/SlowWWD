...
@IonicPage({priority: 'low', segment: 'path-to-which_question', defaultHistory: []})
@Component({selector: 'page-which_question', templateUrl: 'which_question.html', changeDetection: ChangeDetectionStrategy.Default})
export class which_question extends C8oPage  {
	

	public events : Events;
	public actionBeans: ActionBeans;
	public static nameStatic: string = "which_question";
