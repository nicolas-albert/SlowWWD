...
@IonicPage({priority: 'low', segment: 'path-to-thumbnailselectioncolorpicker', defaultHistory: []})
@Component({selector: 'page-thumbnailselectioncolorpicker', templateUrl: 'thumbnailselectioncolorpicker.html', changeDetection: ChangeDetectionStrategy.Default})
export class ThumbnailSelectionColorPicker extends C8oPage  {
	

	public events : Events;
	public actionBeans: ActionBeans;
	public static nameStatic: string = "ThumbnailSelectionColorPicker";
